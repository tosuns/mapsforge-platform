...
public class PreprocessorSelectionWizardPanel implements WizardDescriptor.FinishablePanel<WizardDescriptor> {
    ...
    public PreprocessorSelectionVisualPanel getComponent() {
        if (component == null) {
            component = new PreprocessorSelectionVisualPanel();
        }
        return component;
    }
