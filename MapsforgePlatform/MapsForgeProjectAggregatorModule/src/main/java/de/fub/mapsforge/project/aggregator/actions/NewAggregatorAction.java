...
import de.fub.mapsforge.project.aggregator.actions.wizards.aggregator.AggregatorWizardAction;
...
@ActionID(
        category = "Aggregator",
        id = "de.fub.mapsforge.project.aggregator.actions.NewAggregatorAction")
@ActionRegistration(
...
@ActionReferences({
    @ActionReference(id =
            ...
            category = "Aggregator",
            id = "de.fub.mapsforge.project.aggregator.actions.NewAggregatorAction"),
            path = "Projects/org-mapsforge-project/Aggregator/Actions", position = 0)
})
