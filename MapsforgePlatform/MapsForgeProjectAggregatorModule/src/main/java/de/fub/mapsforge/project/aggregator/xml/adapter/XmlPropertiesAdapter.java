...
import de.fub.mapforgeproject.xml.ProjectFolder;
import de.fub.mapforgeproject.xml.adapters.FolderType;
 ...
 * @author Serdar
 */
public class XmlPropertiesAdapter extends XmlAdapter<FolderType, Map<String, String>> {
