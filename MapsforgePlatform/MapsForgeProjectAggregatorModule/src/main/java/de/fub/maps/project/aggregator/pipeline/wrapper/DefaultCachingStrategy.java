 ...
 */
package de.fub.maps.project.aggregator.pipeline.wrapper;
    ...
    private static class CachingStrategyNode extends AbstractNode {
        ...
        protected Sheet createSheet() {
            ...
            if (this.strategy != null && this.strategy.getPropertySection() != null) {
                ...
                if (propertySection != null) {
                    List<de.fub.maps.project.aggregator.xml.PropertySet> propertySet = propertySection.getPropertySet();

                    for (de.fub.maps.project.aggregator.xml.PropertySet propSet : propertySet) {
                        ...
                        for (de.fub.maps.project.aggregator.xml.Property property : propSet.getProperties()) {
