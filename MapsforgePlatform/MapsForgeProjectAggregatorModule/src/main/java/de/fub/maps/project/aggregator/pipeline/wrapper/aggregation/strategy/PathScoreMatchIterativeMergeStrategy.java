 ...
 */
@NbBundle.Messages({
    "PathScoreMatchIterativeMergeStrategy_Name=Hausdorff Match Frechet Merge",
    "PathScoreMatchIterativeMergeStrategy_Description=No description available",
    "PathScoreMatchIterativeMergeStrategy_Settings_Name=Hausdorff Match Frechet Merge Settings",
    "PathScoreMatchIterativeMergeStrategy_Settings_Description=Parameters to configure this aggregations strategy",
    "PathScoreMatchIterativeMergeStrategy_MaxLookahead_Name=Max Lookahead",
    "PathScoreMatchIterativeMergeStrategy_MaxLookahead_Description=No description available",
    "PathScoreMatchIterativeMergeStrategy_MaxPathDifference_Name=Max Path Difference",
    "PathScoreMatchIterativeMergeStrategy_MaxPathDifference_Description=No description available",
    "PathScoreMatchIterativeMergeStrategy_MaxInitDistance_Name=Max Init Distance",
    "PathScoreMatchIterativeMergeStrategy_MaxInitDistance_Description=No description available",
    "PathScoreMatchIterativeMergeStrategy_MergeHandler_Type_Name=MergeHandler Instance Type",
    "PathScoreMatchIterativeMergeStrategy_MergeHandler_Type_Description=The instance that is responsible for merge the data points",
    "PathScoreMatchIterativeMergeStrategy_TraceDistance_Type_Name=TraceDistance Instance Type",
    "PathScoreMatchIterativeMergeStrategy_TraceDistance_Type_Description=The instance which is responsible fo tracing the distance of a segment"
})
@ServiceProvider(service = AggregationStrategy.class)
public class PathScoreMatchIterativeMergeStrategy extends de.fub.agg2graph.agg.strategy.PathScoreMatchIterativeMergeStrategy implements AggregationStrategy {

    private static final Logger LOG = Logger.getLogger(PathScoreMatchIterativeMergeStrategy.class.getName());
    private static final String PROP_NAME_MAX_LOOKAHEAD = "PathScoreMatchIterativeMergeStrategy.max.lookahead";
    private static final String PROP_NAME_MAX_PATHDIFFERENCE = "PathScoreMatchIterativeMergeStrategy.max.pathdifference";
    private static final String PROP_NAME_MAX_INITDISTANCE = "PathScoreMatchIterativeMergeStrategy.max.initDistance";
    private static final String PROP_NAME_BASE_MERGEHANDLER_TYPE = "PathScoreMatchIterativeMergeStrategy.base.mergehandler.type";
    private static final String PROP_NAME_TRACE_DISTANCE_TYPE = "PathScoreMatchIterativeMergeStrategy.trace.distance.type";
                ...
                for (ProcessDescriptor descriptor : getAggregator().getAggregatorDescriptor().getPipeline().getList()) {
                    if (descriptor != null && AggregationProcess.class.getName().equals(descriptor.getJavaType())) {
                        for (PropertySection section : descriptor.getProperties().getSections()) {
                            if (PathScoreMatchIterativeMergeStrategy.class.getName().equals(section.getId())) {
    ...
    private void reInit() {
        ...
        if (propertySection != null) {
            for (PropertySet propertySet : propertySection.getPropertySet()) {
                if (Bundle.PathScoreMatchIterativeMergeStrategy_Settings_Name().equals(propertySet.getName())) {
    ...
    private PropertySection createDefaultDescriptor() {
        PropertySet propertySet = new PropertySet(
                Bundle.PathScoreMatchIterativeMergeStrategy_Settings_Name(),
                Bundle.PathScoreMatchIterativeMergeStrategy_Settings_Description());
        propertySet.setId(PathScoreMatchIterativeMergeStrategy.class.getName());

        Property property = new Property();
        property.setId(PROP_NAME_MAX_LOOKAHEAD);
        property.setJavaType(Integer.class.getName());
        property.setName(Bundle.PathScoreMatchIterativeMergeStrategy_MaxLookahead_Name());
        property.setDescription(Bundle.PathScoreMatchIterativeMergeStrategy_MaxLookahead_Description());
        ...
        property.setName(Bundle.PathScoreMatchIterativeMergeStrategy_MaxPathDifference_Name());
        property.setDescription(Bundle.PathScoreMatchIterativeMergeStrategy_MaxPathDifference_Description());
        ...
        property.setJavaType(Double.class.getName());
        property.setName(Bundle.PathScoreMatchIterativeMergeStrategy_MaxInitDistance_Name());
        property.setDescription(Bundle.PathScoreMatchIterativeMergeStrategy_MaxInitDistance_Description());
        property.setValue(MessageFormat.format("{0}", getMaxInitDistance()).replaceAll("[^0-9]", "."));
        propertySet.getProperties().add(property);

        property = new Property();
        property.setName(Bundle.PathScoreMatchIterativeMergeStrategy_MergeHandler_Type_Name());
        property.setDescription(Bundle.PathScoreMatchIterativeMergeStrategy_MergeHandler_Type_Description());
        ...
        property = new Property();
        property.setName(Bundle.PathScoreMatchIterativeMergeStrategy_TraceDistance_Type_Name());
        property.setDescription(Bundle.PathScoreMatchIterativeMergeStrategy_TraceDistance_Type_Description());
        ...
        PropertySection section = new PropertySection(
                Bundle.PathScoreMatchIterativeMergeStrategy_Settings_Name(),
                Bundle.PathScoreMatchIterativeMergeStrategy_Settings_Description());
        section.setId(PathScoreMatchIterativeMergeStrategy.class.getName());
    ...
    private static class StrategyNode extends AbstractNode {
        ...
        private final PathScoreMatchIterativeMergeStrategy strategy;

        public StrategyNode(PathScoreMatchIterativeMergeStrategy strategy) {
            super(Children.LEAF);
            ...
            if (strategy != null) {
                ...
                if (propertySection != null) {
                    for (final de.fub.maps.project.aggregator.xml.PropertySet propertySet : propertySection.getPropertySet()) {
                        if (PathScoreMatchIterativeMergeStrategy.class.getName().equals(propertySet.getId())) {
                            ...
                            for (final de.fub.maps.project.aggregator.xml.Property property : properties) {
                                if (PathScoreMatchIterativeMergeStrategy.PROP_NAME_MAX_LOOKAHEAD.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (PathScoreMatchIterativeMergeStrategy.PROP_NAME_MAX_PATHDIFFERENCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (PathScoreMatchIterativeMergeStrategy.PROP_NAME_MAX_INITDISTANCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (PathScoreMatchIterativeMergeStrategy.PROP_NAME_BASE_MERGEHANDLER_TYPE.equals(property.getId())) {
                                    ClassProperty classProperty = new MergeHandlerProperty(propertySection, property);
                                    set.put(classProperty);
                                } else if (PathScoreMatchIterativeMergeStrategy.PROP_NAME_TRACE_DISTANCE_TYPE.equals(property.getId())) {
