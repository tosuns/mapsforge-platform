 ...
 */
@NbBundle.Messages({
    "PathScoreMatchDefaultMergeStrategy_Name=Hausdorff Match Default Merge",
    "PathScoreMatchDefaultMergeStrategy_Description=No description available",
    "PathScoreMatchDefaultMergeStrategy_Settings_Name=Hausdorff Match Default Merge Settings",
    "PathScoreMatchDefaultMergeStrategy_Settings_Description=Parameters to configure this aggregations strategy",
    "PathScoreMatchDefaultMergeStrategy_MaxLookahead_Name=Max Lookahead",
    "PathScoreMatchDefaultMergeStrategy_MaxLookahead_Description=No description available",
    "PathScoreMatchDefaultMergeStrategy_MaxPathDifference_Name=Max Path Difference",
    "PathScoreMatchDefaultMergeStrategy_MaxPathDifference_Description=No description available",
    "PathScoreMatchDefaultMergeStrategy_MaxInitDistance_Name=Max Init Distance",
    "PathScoreMatchDefaultMergeStrategy_MaxInitDistance_Description=No description available",
    "PathScoreMatchDefaultMergeStrategy_MergeHandler_Type_Name=MergeHandler Instance Type",
    "PathScoreMatchDefaultMergeStrategy_MergeHandler_Type_Description=The instance that is responsible for merge the data points",
    "PathScoreMatchDefaultMergeStrategy_TraceDistance_Type_Name=TraceDistance Instance Type",
    "PathScoreMatchDefaultMergeStrategy_TraceDistance_Type_Description=The instance which is responsible fo tracing the distance of a segment"
})
@ServiceProvider(service = AggregationStrategy.class)
public class PathScoreMatchDefaultMergeStrategy extends de.fub.agg2graph.agg.strategy.PathScoreMatchDefaultMergeStrategy implements AggregationStrategy {

    private static final Logger LOG = Logger.getLogger(PathScoreMatchDefaultMergeStrategy.class.getName());
    private static final String PROP_NAME_MAX_LOOKAHEAD = "HausdorffMatchIterativeMergeStrategy.max.lookahead";
    private static final String PROP_NAME_MAX_PATHDIFFERENCE = "HausdorffMatchIterativeMergeStrategy.max.pathdifference";
    private static final String PROP_NAME_MAX_INITDISTANCE = "HausdorffMatchIterativeMergeStrategy.max.initDistance";
    private static final String PROP_NAME_BASE_MERGEHANDLER_TYPE = "HausdorffMatchIterativeMergeStrategy.base.mergehandler.type";
    private static final String PROP_NAME_TRACE_DISTANCE_TYPE = "HausdorffMatchIterativeMergeStrategy.trace.distance.type";
                ...
                for (ProcessDescriptor descriptor : getAggregator().getAggregatorDescriptor().getPipeline().getList()) {
                    if (descriptor != null && AggregationProcess.class.getName().equals(descriptor.getJavaType())) {
                        for (PropertySection section : descriptor.getProperties().getSections()) {
                            if (PathScoreMatchDefaultMergeStrategy.class.getName().equals(section.getId())) {
    ...
    private void reInit() {
        ...
        if (propertySection != null) {
            for (PropertySet propertySet : propertySection.getPropertySet()) {
                if (Bundle.PathScoreMatchDefaultMergeStrategy_Settings_Name().equals(propertySet.getName())) {
    ...
    private PropertySection createDefaultDescriptor() {
        PropertySet propertySet = new PropertySet(
                Bundle.PathScoreMatchDefaultMergeStrategy_Settings_Name(),
                Bundle.PathScoreMatchDefaultMergeStrategy_Settings_Description());
        propertySet.setId(PathScoreMatchDefaultMergeStrategy.class.getName());

        Property property = new Property();
        property.setId(PROP_NAME_MAX_LOOKAHEAD);
        property.setJavaType(Integer.class.getName());
        property.setName(Bundle.PathScoreMatchDefaultMergeStrategy_MaxLookahead_Name());
        property.setDescription(Bundle.PathScoreMatchDefaultMergeStrategy_MaxLookahead_Description());
        ...
        property.setName(Bundle.PathScoreMatchDefaultMergeStrategy_MaxPathDifference_Name());
        property.setDescription(Bundle.PathScoreMatchDefaultMergeStrategy_MaxPathDifference_Description());
        ...
        property.setJavaType(Double.class.getName());
        property.setName(Bundle.PathScoreMatchDefaultMergeStrategy_MaxInitDistance_Name());
        property.setDescription(Bundle.PathScoreMatchDefaultMergeStrategy_MaxInitDistance_Description());
        property.setValue(MessageFormat.format("{0}", getMaxInitDistance()).replaceAll("[^0-9]", "."));
        propertySet.getProperties().add(property);

        property = new Property();
        property.setName(Bundle.PathScoreMatchDefaultMergeStrategy_MergeHandler_Type_Name());
        property.setDescription(Bundle.PathScoreMatchDefaultMergeStrategy_MergeHandler_Type_Description());
        ...
        property = new Property();
        property.setName(Bundle.PathScoreMatchDefaultMergeStrategy_TraceDistance_Type_Name());
        property.setDescription(Bundle.PathScoreMatchDefaultMergeStrategy_TraceDistance_Type_Description());
        ...
        PropertySection section = new PropertySection(
                Bundle.PathScoreMatchDefaultMergeStrategy_Settings_Name(),
                Bundle.PathScoreMatchDefaultMergeStrategy_Settings_Description());
        section.setId(PathScoreMatchDefaultMergeStrategy.class.getName());
    ...
    private static class StrategyNode extends AbstractNode {
        ...
        private final PathScoreMatchDefaultMergeStrategy strategy;

        public StrategyNode(PathScoreMatchDefaultMergeStrategy strategy) {
            super(Children.LEAF);
            ...
            if (strategy != null) {
                ...
                if (propertySection != null) {
                    for (final de.fub.maps.project.aggregator.xml.PropertySet propertySet : propertySection.getPropertySet()) {
                        if (PathScoreMatchDefaultMergeStrategy.class.getName().equals(propertySet.getId())) {
                            ...
                            for (final de.fub.maps.project.aggregator.xml.Property property : properties) {
                                if (PathScoreMatchDefaultMergeStrategy.PROP_NAME_MAX_LOOKAHEAD.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (PathScoreMatchDefaultMergeStrategy.PROP_NAME_MAX_PATHDIFFERENCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (PathScoreMatchDefaultMergeStrategy.PROP_NAME_MAX_INITDISTANCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (PathScoreMatchDefaultMergeStrategy.PROP_NAME_BASE_MERGEHANDLER_TYPE.equals(property.getId())) {
                                    ClassProperty classProperty = new MergeHandlerProperty(propertySection, property);
                                    set.put(classProperty);
                                } else if (PathScoreMatchDefaultMergeStrategy.PROP_NAME_TRACE_DISTANCE_TYPE.equals(property.getId())) {
