 ...
 */
@NbBundle.Messages({
    "GpxmergeMatchAttractionMergeStrategy_Name=Gpx Merge Match Attraction Merge",
    "GpxmergeMatchAttractionMergeStrategy_Description=No description available",
    "GpxmergeMatchAttractionMergeStrategy_Settings_Name=Gpx Merge Match Attraction Merge Settings",
    "GpxmergeMatchAttractionMergeStrategy_Settings_Description=Parameters to configure this aggregations strategy",
    "GpxmergeMatchAttractionMergeStrategy_MaxLookahead_Name=Max Lookahead",
    "GpxmergeMatchAttractionMergeStrategy_MaxLookahead_Description=No description available",
    "GpxmergeMatchAttractionMergeStrategy_MaxPathDifference_Name=Max Path Difference",
    "GpxmergeMatchAttractionMergeStrategy_MaxPathDifference_Description=No description available",
    "GpxmergeMatchAttractionMergeStrategy_MaxInitDistance_Name=Max Init Distance",
    "GpxmergeMatchAttractionMergeStrategy_MaxInitDistance_Description=No description available",
    "GpxmergeMatchAttractionMergeStrategy_MergeHandler_Type_Name=MergeHandler Instance Type",
    "GpxmergeMatchAttractionMergeStrategy_MergeHandler_Type_Description=The instance that is responsible for merge the data points",
    "GpxmergeMatchAttractionMergeStrategy_TraceDistance_Type_Name=TraceDistance Instance Type",
    "GpxmergeMatchAttractionMergeStrategy_TraceDistance_Type_Description=The instance which is responsible fo tracing the distance of a segment"
})
@ServiceProvider(service = AggregationStrategy.class)
public class GpxmergeMatchAttractionMergeStrategy extends de.fub.agg2graph.agg.strategy.GpxmergeMatchAttractionMergeStrategy implements AggregationStrategy {

    private static final Logger LOG = Logger.getLogger(GpxmergeMatchAttractionMergeStrategy.class.getName());

    private static final String PROP_NAME_MAX_LOOKAHEAD = "GpxmergeMatchAttractionMergeStrategy.max.lookahead";
    private static final String PROP_NAME_MAX_PATHDIFFERENCE = "GpxmergeMatchAttractionMergeStrategy.max.pathdifference";
    private static final String PROP_NAME_MAX_INITDISTANCE = "GpxmergeMatchAttractionMergeStrategy.max.initDistance";
    private static final String PROP_NAME_BASE_MERGEHANDLER_TYPE = "GpxmergeMatchAttractionMergeStrategy.base.mergehandler.type";
    private static final String PROP_NAME_TRACE_DISTANCE_TYPE = "GpxmergeMatchAttractionMergeStrategy.trace.distance.type";
    ...
    public Node getNodeDelegate() {
        if (nodeDelegate == null) {
            nodeDelegate = new StrategyNode(GpxmergeMatchAttractionMergeStrategy.this);
        }
        return nodeDelegate;
    }
                ...
                for (ProcessDescriptor descriptor : getAggregator().getAggregatorDescriptor().getPipeline().getList()) {
                    if (descriptor != null && AggregationProcess.class.getName().equals(descriptor.getJavaType())) {
                        for (PropertySection section : descriptor.getProperties().getSections()) {
                            if (GpxmergeMatchAttractionMergeStrategy.class.getName().equals(section.getId())) {
    ...
    protected void reInit() {
        ...
        if (propertySection != null) {
            for (PropertySet propertySet : propertySection.getPropertySet()) {
                if (Bundle.GpxmergeMatchAttractionMergeStrategy_Settings_Name().equals(propertySet.getName())) {
    ...
    protected PropertySection createDefaultDescriptor() {
        PropertySet propertySet = new PropertySet(
                Bundle.GpxmergeMatchAttractionMergeStrategy_Settings_Name(),
                Bundle.GpxmergeMatchAttractionMergeStrategy_Settings_Description());
        propertySet.setId(GpxmergeMatchAttractionMergeStrategy.class.getName());

        Property property = new Property();
        property.setId(PROP_NAME_MAX_LOOKAHEAD);
        property.setJavaType(Integer.class.getName());
        property.setName(Bundle.GpxmergeMatchAttractionMergeStrategy_MaxLookahead_Name());
        property.setDescription(Bundle.GpxmergeMatchAttractionMergeStrategy_MaxLookahead_Description());
        ...
        property.setName(Bundle.GpxmergeMatchAttractionMergeStrategy_MaxPathDifference_Name());
        property.setDescription(Bundle.GpxmergeMatchAttractionMergeStrategy_MaxPathDifference_Description());
        ...
        property.setJavaType(Double.class.getName());
        property.setName(Bundle.GpxmergeMatchAttractionMergeStrategy_MaxInitDistance_Name());
        property.setDescription(Bundle.GpxmergeMatchAttractionMergeStrategy_MaxInitDistance_Description());
        property.setValue(MessageFormat.format("{0}", getMaxLookahead()).replaceAll("\\,", "."));
        propertySet.getProperties().add(property);

        property = new Property();
        property.setName(Bundle.GpxmergeMatchAttractionMergeStrategy_MergeHandler_Type_Name());
        property.setDescription(Bundle.GpxmergeMatchAttractionMergeStrategy_MergeHandler_Type_Description());
        property.setId(PROP_NAME_BASE_MERGEHANDLER_TYPE);
        property.setJavaType(String.class.getName());
        property.setValue(AttractionForceMerge.class.getName());
        propertySet.getProperties().add(property);

        property = new Property();
        property.setName(Bundle.GpxmergeMatchAttractionMergeStrategy_TraceDistance_Type_Name());
        property.setDescription(Bundle.GpxmergeMatchAttractionMergeStrategy_TraceDistance_Type_Description());
        ...
        PropertySection section = new PropertySection(
                Bundle.GpxmergeMatchAttractionMergeStrategy_Settings_Name(),
                Bundle.GpxmergeMatchAttractionMergeStrategy_Settings_Description());
        section.setId(GpxmergeMatchAttractionMergeStrategy.class.getName());
        section.getPropertySet().add(propertySet);

        MergeHandler handler = null;
        try {
            handler = MergeHandler.Factory.find(AttractionForceMerge.class.getName());
            if (handler != null) {
    ...
    private static class StrategyNode extends AbstractNode {
        ...
        private final GpxmergeMatchAttractionMergeStrategy strategy;

        public StrategyNode(GpxmergeMatchAttractionMergeStrategy strategy) {
            super(Children.LEAF);
            ...
            if (strategy != null) {
                ...
                if (propertySection != null) {
                    for (final de.fub.maps.project.aggregator.xml.PropertySet propertySet : propertySection.getPropertySet()) {
                        if (GpxmergeMatchAttractionMergeStrategy.class.getName().equals(propertySet.getId())) {
                            ...
                            for (final de.fub.maps.project.aggregator.xml.Property property : properties) {
                                if (GpxmergeMatchAttractionMergeStrategy.PROP_NAME_MAX_LOOKAHEAD.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (GpxmergeMatchAttractionMergeStrategy.PROP_NAME_MAX_PATHDIFFERENCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (GpxmergeMatchAttractionMergeStrategy.PROP_NAME_MAX_INITDISTANCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (GpxmergeMatchAttractionMergeStrategy.PROP_NAME_BASE_MERGEHANDLER_TYPE.equals(property.getId())) {
                                    ClassProperty classProperty = new MergeHandlerProperty(propertySection, property);
                                    set.put(classProperty);
                                } else if (GpxmergeMatchAttractionMergeStrategy.PROP_NAME_TRACE_DISTANCE_TYPE.equals(property.getId())) {
                    ...
                    IMergeHandler handler = strategy.getBaseMergeHandler();
                    if (handler instanceof MergeHandler) {
                        MergeHandler mergeHandler = (MergeHandler) handler;
        ...
        private class MergeHandlerProperty extends ClassProperty {
            ...
            public MergeHandlerProperty(PropertySection propertySection, de.fub.maps.project.aggregator.xml.Property property) {
                ...
                wrapper = strategy.getMergeHandler() != null
                        ? new ClassWrapper(strategy.getBaseMergeHandler().getClass())
                        : new ClassWrapper(DefaultMergeHandler.class);
            }
