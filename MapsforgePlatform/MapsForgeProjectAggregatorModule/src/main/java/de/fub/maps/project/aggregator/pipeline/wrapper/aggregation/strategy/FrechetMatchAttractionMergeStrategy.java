 ...
 */
@NbBundle.Messages({
    "FrechetMatchAttractionMergeStrategy_Name=Frechet Merge Match Attraction Merge",
    "FrechetMatchAttractionMergeStrategy_Description=No description available",
    "FrechetMatchAttractionMergeStrategy_Settings_Name=Frechet Merge Match Attraction Merge Settings",
    "FrechetMatchAttractionMergeStrategy_Settings_Description=Parameters to configure this aggregations strategy",
    "FrechetMatchAttractionMergeStrategy_MaxLookahead_Name=Max Lookahead",
    "FrechetMatchAttractionMergeStrategy_MaxLookahead_Description=No description available",
    "FrechetMatchAttractionMergeStrategy_MaxPathDifference_Name=Max Path Difference",
    "FrechetMatchAttractionMergeStrategy_MaxPathDifference_Description=No description available",
    "FrechetMatchAttractionMergeStrategy_MaxInitDistance_Name=Max Init Distance",
    "FrechetMatchAttractionMergeStrategy_MaxInitDistance_Description=No description available",
    "FrechetMatchAttractionMergeStrategy_MergeHandler_Type_Name=MergeHandler Instance Type",
    "FrechetMatchAttractionMergeStrategy_MergeHandler_Type_Description=The instance that is responsible for merge the data points",
    "FrechetMatchAttractionMergeStrategy_TraceDistance_Type_Name=TraceDistance Instance Type",
    "FrechetMatchAttractionMergeStrategy_TraceDistance_Type_Description=The instance which is responsible fo tracing the distance of a segment"
})
@ServiceProvider(service = AggregationStrategy.class)
public class FrechetMatchAttractionMergeStrategy extends de.fub.agg2graph.agg.strategy.FrechetMatchAttractionMergeStrategy implements AggregationStrategy {

    private static final Logger LOG = Logger.getLogger(FrechetMatchAttractionMergeStrategy.class.getName());
    private static final String PROP_NAME_MAX_LOOKAHEAD = "Frechet.max.lookahead";
    private static final String PROP_NAME_MAX_PATHDIFFERENCE = "Frechet.max.pathdifference";
    private static final String PROP_NAME_MAX_INITDISTANCE = "Frechet.max.initDistance";
    private static final String PROP_NAME_BASE_MERGEHANDLER_TYPE = "Frechet.base.mergehandler.type";
    private static final String PROP_NAME_TRACE_DISTANCE_TYPE = "Frechet.trace.distance.type";
                ...
                for (ProcessDescriptor descriptor : getAggregator().getAggregatorDescriptor().getPipeline().getList()) {
                    if (descriptor != null && AggregationProcess.class.getName().equals(descriptor.getJavaType())) {
                        for (PropertySection section : descriptor.getProperties().getSections()) {
                            if (FrechetMatchAttractionMergeStrategy.class.getName().equals(section.getId())) {
    ...
    private void reInit() {
        ...
        if (propertySection != null) {
            for (PropertySet propertySet : propertySection.getPropertySet()) {
                if (Bundle.FrechetMatchAttractionMergeStrategy_Settings_Name().equals(propertySet.getName())) {
    ...
    private PropertySection createDefaultDescriptor() {
        PropertySet propertySet = new PropertySet(
                Bundle.FrechetMatchAttractionMergeStrategy_Settings_Name(),
                Bundle.FrechetMatchAttractionMergeStrategy_Settings_Description());
        propertySet.setId(FrechetMatchAttractionMergeStrategy.class.getName());

        Property property = new Property();
        property.setId(PROP_NAME_MAX_LOOKAHEAD);
        property.setJavaType(Integer.class.getName());
        property.setName(Bundle.FrechetMatchAttractionMergeStrategy_MaxLookahead_Name());
        property.setDescription(Bundle.FrechetMatchAttractionMergeStrategy_MaxLookahead_Description());
        ...
        property.setName(Bundle.FrechetMatchAttractionMergeStrategy_MaxPathDifference_Name());
        property.setDescription(Bundle.FrechetMatchAttractionMergeStrategy_MaxPathDifference_Description());
        ...
        property.setJavaType(Double.class.getName());
        property.setName(Bundle.FrechetMatchAttractionMergeStrategy_MaxInitDistance_Name());
        property.setDescription(Bundle.FrechetMatchAttractionMergeStrategy_MaxInitDistance_Description());
        property.setValue(MessageFormat.format("{0}", getMaxInitDistance()).replaceAll("[^0-9]", "."));
        propertySet.getProperties().add(property);

        property = new Property();
        property.setName(Bundle.FrechetMatchAttractionMergeStrategy_MergeHandler_Type_Name());
        property.setDescription(Bundle.FrechetMatchAttractionMergeStrategy_MergeHandler_Type_Description());
        ...
        property = new Property();
        property.setName(Bundle.FrechetMatchAttractionMergeStrategy_TraceDistance_Type_Name());
        property.setDescription(Bundle.FrechetMatchAttractionMergeStrategy_TraceDistance_Type_Description());
        property.setId(PROP_NAME_TRACE_DISTANCE_TYPE);
        property.setJavaType(String.class.getName());
        property.setValue(FreeSpaceMatch.class.getName());
        propertySet.getProperties().add(property);

        PropertySection section = new PropertySection(
                Bundle.FrechetMatchAttractionMergeStrategy_Settings_Name(),
                Bundle.FrechetMatchAttractionMergeStrategy_Settings_Description());
        section.setId(FrechetMatchAttractionMergeStrategy.class.getName());
        ...
        try {
            traceHandler = TraceDistance.Factory.find(FreeSpaceMatch.class.getName());
    ...
    private static class StrategyNode extends AbstractNode {
        ...
        private final FrechetMatchAttractionMergeStrategy strategy;

        public StrategyNode(FrechetMatchAttractionMergeStrategy strategy) {
            super(Children.LEAF);
            ...
            if (strategy != null) {
                ...
                if (propertySection != null) {
                    for (final de.fub.maps.project.aggregator.xml.PropertySet propertySet : propertySection.getPropertySet()) {
                        if (FrechetMatchAttractionMergeStrategy.class.getName().equals(propertySet.getId())) {
                            ...
                            for (final de.fub.maps.project.aggregator.xml.Property property : properties) {
                                if (FrechetMatchAttractionMergeStrategy.PROP_NAME_MAX_LOOKAHEAD.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (FrechetMatchAttractionMergeStrategy.PROP_NAME_MAX_PATHDIFFERENCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (FrechetMatchAttractionMergeStrategy.PROP_NAME_MAX_INITDISTANCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (FrechetMatchAttractionMergeStrategy.PROP_NAME_BASE_MERGEHANDLER_TYPE.equals(property.getId())) {
                                    ClassProperty classProperty = new MergeHandlerProperty(propertySection, property);
                                    set.put(classProperty);
                                } else if (FrechetMatchAttractionMergeStrategy.PROP_NAME_TRACE_DISTANCE_TYPE.equals(property.getId())) {
