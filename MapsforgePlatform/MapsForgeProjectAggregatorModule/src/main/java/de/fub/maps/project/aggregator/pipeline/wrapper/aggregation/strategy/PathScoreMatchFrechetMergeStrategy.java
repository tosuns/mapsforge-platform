 ...
 */
@NbBundle.Messages({
    "PathScoreMatchFrechetMergeStrategy_Name=Hausdorff Match Frechet Merge",
    "PathScoreMatchFrechetMergeStrategy_Description=No description available",
    "PathScoreMatchFrechetMergeStrategy_Settings_Name=Hausdorff Match Frechet Merge Settings",
    "PathScoreMatchFrechetMergeStrategy_Settings_Description=Parameters to configure this aggregations strategy",
    "PathScoreMatchFrechetMergeStrategy_MaxLookahead_Name=Max Lookahead",
    "PathScoreMatchFrechetMergeStrategy_MaxLookahead_Description=No description available",
    "PathScoreMatchFrechetMergeStrategy_MaxPathDifference_Name=Max Path Difference",
    "PathScoreMatchFrechetMergeStrategy_MaxPathDifference_Description=No description available",
    "PathScoreMatchFrechetMergeStrategy_MaxInitDistance_Name=Max Init Distance",
    "PathScoreMatchFrechetMergeStrategy_MaxInitDistance_Description=No description available",
    "PathScoreMatchFrechetMergeStrategy_MergeHandler_Type_Name=MergeHandler Instance Type",
    "PathScoreMatchFrechetMergeStrategy_MergeHandler_Type_Description=The instance that is responsible for merge the data points",
    "PathScoreMatchFrechetMergeStrategy_TraceDistance_Type_Name=TraceDistance Instance Type",
    "PathScoreMatchFrechetMergeStrategy_TraceDistance_Type_Description=The instance which is responsible fo tracing the distance of a segment"
})
@ServiceProvider(service = AggregationStrategy.class)
public class PathScoreMatchFrechetMergeStrategy extends de.fub.agg2graph.agg.strategy.PathScoreMatchFrechetMergeStrategy implements AggregationStrategy {

    private static final Logger LOG = Logger.getLogger(PathScoreMatchFrechetMergeStrategy.class.getName());
    private static final String PROP_NAME_MAX_LOOKAHEAD = "PathScoreMatchFrechetMergeStrategy.max.lookahead";
    private static final String PROP_NAME_MAX_PATHDIFFERENCE = "PathScoreMatchFrechetMergeStrategy.max.pathdifference";
    private static final String PROP_NAME_MAX_INITDISTANCE = "PathScoreMatchFrechetMergeStrategy.max.initDistance";
    private static final String PROP_NAME_BASE_MERGEHANDLER_TYPE = "PathScoreMatchFrechetMergeStrategy.base.mergehandler.type";
    private static final String PROP_NAME_TRACE_DISTANCE_TYPE = "PathScoreMatchFrechetMergeStrategy.trace.distance.type";
                ...
                for (ProcessDescriptor descriptor : getAggregator().getAggregatorDescriptor().getPipeline().getList()) {
                    if (descriptor != null && AggregationProcess.class.getName().equals(descriptor.getJavaType())) {
                        for (PropertySection section : descriptor.getProperties().getSections()) {
                            if (PathScoreMatchFrechetMergeStrategy.class.getName().equals(section.getId())) {
    ...
    private void reInit() {
        ...
        if (propertySection != null) {
            for (PropertySet propertySet : propertySection.getPropertySet()) {
                if (Bundle.PathScoreMatchFrechetMergeStrategy_Settings_Name().equals(propertySet.getName())) {
    ...
    private PropertySection createDefaultDescriptor() {
        PropertySet propertySet = new PropertySet(
                Bundle.PathScoreMatchFrechetMergeStrategy_Settings_Name(),
                Bundle.PathScoreMatchFrechetMergeStrategy_Settings_Description());
        propertySet.setId(PathScoreMatchFrechetMergeStrategy.class.getName());

        Property property = new Property();
        property.setId(PROP_NAME_MAX_LOOKAHEAD);
        property.setJavaType(Integer.class.getName());
        property.setName(Bundle.PathScoreMatchFrechetMergeStrategy_MaxLookahead_Name());
        property.setDescription(Bundle.PathScoreMatchFrechetMergeStrategy_MaxLookahead_Description());
        ...
        property.setName(Bundle.PathScoreMatchFrechetMergeStrategy_MaxPathDifference_Name());
        property.setDescription(Bundle.PathScoreMatchFrechetMergeStrategy_MaxPathDifference_Description());
        ...
        property.setJavaType(Double.class.getName());
        property.setName(Bundle.PathScoreMatchFrechetMergeStrategy_MaxInitDistance_Name());
        property.setDescription(Bundle.PathScoreMatchFrechetMergeStrategy_MaxInitDistance_Description());
        property.setValue(MessageFormat.format("{0}", getMaxInitDistance()).replaceAll("[^0-9]", "."));
        propertySet.getProperties().add(property);

        property = new Property();
        property.setName(Bundle.PathScoreMatchFrechetMergeStrategy_MergeHandler_Type_Name());
        property.setDescription(Bundle.PathScoreMatchFrechetMergeStrategy_MergeHandler_Type_Description());
        property.setId(PROP_NAME_BASE_MERGEHANDLER_TYPE);
        property.setJavaType(String.class.getName());
        property.setValue(FrechetBasedMerge.class.getName());
        propertySet.getProperties().add(property);

        property = new Property();
        property.setName(Bundle.PathScoreMatchFrechetMergeStrategy_TraceDistance_Type_Name());
        property.setDescription(Bundle.PathScoreMatchFrechetMergeStrategy_TraceDistance_Type_Description());
        ...
        PropertySection section = new PropertySection(
                Bundle.PathScoreMatchFrechetMergeStrategy_Settings_Name(),
                Bundle.PathScoreMatchFrechetMergeStrategy_Settings_Description());
        section.setId(PathScoreMatchFrechetMergeStrategy.class.getName());
        section.getPropertySet().add(propertySet);

        MergeHandler handler = null;
        try {
            handler = MergeHandler.Factory.find(FrechetBasedMerge.class.getName());
            if (handler != null) {
    ...
    private static class StrategyNode extends AbstractNode {
        ...
        private final PathScoreMatchFrechetMergeStrategy strategy;

        public StrategyNode(PathScoreMatchFrechetMergeStrategy strategy) {
            super(Children.LEAF);
            ...
            if (strategy != null) {
                ...
                if (propertySection != null) {
                    for (final de.fub.maps.project.aggregator.xml.PropertySet propertySet : propertySection.getPropertySet()) {
                        if (PathScoreMatchFrechetMergeStrategy.class.getName().equals(propertySet.getId())) {
                            ...
                            for (final de.fub.maps.project.aggregator.xml.Property property : properties) {
                                if (PathScoreMatchFrechetMergeStrategy.PROP_NAME_MAX_LOOKAHEAD.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (PathScoreMatchFrechetMergeStrategy.PROP_NAME_MAX_PATHDIFFERENCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (PathScoreMatchFrechetMergeStrategy.PROP_NAME_MAX_INITDISTANCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (PathScoreMatchFrechetMergeStrategy.PROP_NAME_BASE_MERGEHANDLER_TYPE.equals(property.getId())) {
                                    ClassProperty classProperty = new MergeHandlerProperty(propertySection, property);
                                    set.put(classProperty);
                                } else if (PathScoreMatchFrechetMergeStrategy.PROP_NAME_TRACE_DISTANCE_TYPE.equals(property.getId())) {
