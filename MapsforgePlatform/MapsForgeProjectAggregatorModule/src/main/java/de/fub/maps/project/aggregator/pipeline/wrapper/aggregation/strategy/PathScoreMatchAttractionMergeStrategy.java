 ...
 */
@NbBundle.Messages({
    "PathScoreMatchAttractionMergeStrategy_Name=PathScore Match Attraction Merge",
    "PathScoreMatchAttractionMergeStrategy_Description=No description available",
    "PathScoreMatchAttractionMergeStrategy_Settings_Name=PathScore Match Attraction Merge Settings",
    "PathScoreMatchAttractionMergeStrategy_Settings_Description=Parameters to configure this aggregations strategy",
    "PathScoreMatchAttractionMergeStrategy_MaxLookahead_Name=Max Lookahead",
    "PathScoreMatchAttractionMergeStrategy_MaxLookahead_Description=No description available",
    "PathScoreMatchAttractionMergeStrategy_MaxPathDifference_Name=Max Path Difference",
    "PathScoreMatchAttractionMergeStrategy_MaxPathDifference_Description=No description available",
    "PathScoreMatchAttractionMergeStrategy_MaxInitDistance_Name=Max Init Distance",
    "PathScoreMatchAttractionMergeStrategy_MaxInitDistance_Description=No description available",
    "PathScoreMatchAttractionMergeStrategy_MergeHandler_Type_Name=MergeHandler Instance Type",
    "PathScoreMatchAttractionMergeStrategy_MergeHandler_Type_Description=The instance that is responsible for merge the data points",
    "PathScoreMatchAttractionMergeStrategy_TraceDistance_Type_Name=TraceDistance Instance Type",
    "PathScoreMatchAttractionMergeStrategy_TraceDistance_Type_Description=The instance which is responsible fo tracing the distance of a segment"
})
@ServiceProvider(service = AggregationStrategy.class)
public class PathScoreMatchAttractionMergeStrategy extends de.fub.agg2graph.agg.strategy.PathScoreMatchAttractionMergeStrategy implements AggregationStrategy {

    private static final Logger LOG = Logger.getLogger(PathScoreMatchAttractionMergeStrategy.class.getName());
    private static final String PROP_NAME_MAX_LOOKAHEAD = "PathScoreMatchAttractionMergeStrategy.max.lookahead";
    private static final String PROP_NAME_MAX_PATHDIFFERENCE = "PathScoreMatchAttractionMergeStrategy.max.pathdifference";
    private static final String PROP_NAME_MAX_INITDISTANCE = "PathScoreMatchAttractionMergeStrategy.max.initDistance";
    private static final String PROP_NAME_BASE_MERGEHANDLER_TYPE = "PathScoreMatchAttractionMergeStrategy.base.mergehandler.type";
    private static final String PROP_NAME_TRACE_DISTANCE_TYPE = "PathScoreMatchAttractionMergeStrategy.trace.distance.type";
                ...
                for (ProcessDescriptor descriptor : getAggregator().getAggregatorDescriptor().getPipeline().getList()) {
                    if (descriptor != null && AggregationProcess.class.getName().equals(descriptor.getJavaType())) {
                        for (PropertySection section : descriptor.getProperties().getSections()) {
                            if (PathScoreMatchAttractionMergeStrategy.class.getName().equals(section.getId())) {
    ...
    private void reInit() {
        ...
        if (propertySection != null) {
            for (PropertySet propertySet : propertySection.getPropertySet()) {
                if (Bundle.PathScoreMatchAttractionMergeStrategy_Settings_Name().equals(propertySet.getName())) {
    ...
    private PropertySection createDefaultDescriptor() {
        PropertySet propertySet = new PropertySet(
                Bundle.PathScoreMatchAttractionMergeStrategy_Settings_Name(),
                Bundle.PathScoreMatchAttractionMergeStrategy_Settings_Description());
        propertySet.setId(PathScoreMatchAttractionMergeStrategy.class.getName());

        Property property = new Property();
        property.setId(PROP_NAME_MAX_LOOKAHEAD);
        property.setJavaType(Integer.class.getName());
        property.setName(Bundle.PathScoreMatchAttractionMergeStrategy_MaxLookahead_Name());
        property.setDescription(Bundle.PathScoreMatchAttractionMergeStrategy_MaxLookahead_Description());
        ...
        property.setName(Bundle.PathScoreMatchAttractionMergeStrategy_MaxPathDifference_Name());
        property.setDescription(Bundle.PathScoreMatchAttractionMergeStrategy_MaxPathDifference_Description());
        ...
        property.setJavaType(Double.class.getName());
        property.setName(Bundle.PathScoreMatchAttractionMergeStrategy_MaxInitDistance_Name());
        property.setDescription(Bundle.PathScoreMatchAttractionMergeStrategy_MaxInitDistance_Description());
        property.setValue(MessageFormat.format("{0}", getMaxInitDistance()).replaceAll("[^0-9]", "."));
        propertySet.getProperties().add(property);

        property = new Property();
        property.setName(Bundle.PathScoreMatchAttractionMergeStrategy_MergeHandler_Type_Name());
        property.setDescription(Bundle.PathScoreMatchAttractionMergeStrategy_MergeHandler_Type_Description());
        ...
        property = new Property();
        property.setName(Bundle.PathScoreMatchAttractionMergeStrategy_TraceDistance_Type_Name());
        property.setDescription(Bundle.PathScoreMatchAttractionMergeStrategy_TraceDistance_Type_Description());
        property.setId(PROP_NAME_TRACE_DISTANCE_TYPE);
        property.setJavaType(String.class.getName());
        property.setValue(PathScoreDistance.class.getName());
        propertySet.getProperties().add(property);

        PropertySection section = new PropertySection(
                Bundle.PathScoreMatchAttractionMergeStrategy_Settings_Name(),
                Bundle.PathScoreMatchAttractionMergeStrategy_Settings_Description());
        section.setId(PathScoreMatchAttractionMergeStrategy.class.getName());
        ...
        try {
            traceHandler = TraceDistance.Factory.find(PathScoreDistance.class.getName());
    ...
    private static class StrategyNode extends AbstractNode {
        ...
        private final PathScoreMatchAttractionMergeStrategy strategy;

        public StrategyNode(PathScoreMatchAttractionMergeStrategy strategy) {
            super(Children.LEAF);
            ...
            if (strategy != null) {
                ...
                if (propertySection != null) {
                    for (final de.fub.maps.project.aggregator.xml.PropertySet propertySet : propertySection.getPropertySet()) {
                        if (PathScoreMatchAttractionMergeStrategy.class.getName().equals(propertySet.getId())) {
                            ...
                            for (final de.fub.maps.project.aggregator.xml.Property property : properties) {
                                if (PathScoreMatchAttractionMergeStrategy.PROP_NAME_MAX_LOOKAHEAD.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (PathScoreMatchAttractionMergeStrategy.PROP_NAME_MAX_PATHDIFFERENCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (PathScoreMatchAttractionMergeStrategy.PROP_NAME_MAX_INITDISTANCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (PathScoreMatchAttractionMergeStrategy.PROP_NAME_BASE_MERGEHANDLER_TYPE.equals(property.getId())) {
                                    ClassProperty classProperty = new MergeHandlerProperty(propertySection, property);
                                    set.put(classProperty);
                                } else if (PathScoreMatchAttractionMergeStrategy.PROP_NAME_TRACE_DISTANCE_TYPE.equals(property.getId())) {
