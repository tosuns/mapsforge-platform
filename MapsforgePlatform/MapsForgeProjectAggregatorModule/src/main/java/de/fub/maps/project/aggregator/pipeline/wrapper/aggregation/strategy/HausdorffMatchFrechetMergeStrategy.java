 ...
 */
@NbBundle.Messages({
    "HausdorffMatchFrechetMergeStrategy_Name=Hausdorff Match Iterative Merge",
    "HausdorffMatchFrechetMergeStrategy_Description=No description available",
    "HausdorffMatchFrechetMergeStrategy_Settings_Name=Hausdorff Match Iterative Merge Settings",
    "HausdorffMatchFrechetMergeStrategy_Settings_Description=Parameters to configure this aggregations strategy",
    "HausdorffMatchFrechetMergeStrategy_MaxLookahead_Name=Max Lookahead",
    "HausdorffMatchFrechetMergeStrategy_MaxLookahead_Description=No description available",
    "HausdorffMatchFrechetMergeStrategy_MaxPathDifference_Name=Max Path Difference",
    "HausdorffMatchFrechetMergeStrategy_MaxPathDifference_Description=No description available",
    "HausdorffMatchFrechetMergeStrategy_MaxInitDistance_Name=Max Init Distance",
    "HausdorffMatchFrechetMergeStrategy_MaxInitDistance_Description=No description available",
    "HausdorffMatchFrechetMergeStrategy_MergeHandler_Type_Name=MergeHandler Instance Type",
    "HausdorffMatchFrechetMergeStrategy_MergeHandler_Type_Description=The instance that is responsible for merge the data points",
    "HausdorffMatchFrechetMergeStrategy_TraceDistance_Type_Name=TraceDistance Instance Type",
    "HausdorffMatchFrechetMergeStrategy_TraceDistance_Type_Description=The instance which is responsible fo tracing the distance of a segment"
})
@ServiceProvider(service = AggregationStrategy.class)
public class HausdorffMatchFrechetMergeStrategy extends de.fub.agg2graph.agg.strategy.HausdorffMatchFrechetMergeStrategy implements AggregationStrategy {

    private static final Logger LOG = Logger.getLogger(HausdorffMatchFrechetMergeStrategy.class.getName());
    private static final String PROP_NAME_MAX_LOOKAHEAD = "HausdorffMatchFrechetMergeStrategy.max.lookahead";
    private static final String PROP_NAME_MAX_PATHDIFFERENCE = "HausdorffMatchFrechetMergeStrategy.max.pathdifference";
    private static final String PROP_NAME_MAX_INITDISTANCE = "HausdorffMatchFrechetMergeStrategy.max.initDistance";
    private static final String PROP_NAME_BASE_MERGEHANDLER_TYPE = "HausdorffMatchFrechetMergeStrategy.base.mergehandler.type";
    private static final String PROP_NAME_TRACE_DISTANCE_TYPE = "HausdorffMatchFrechetMergeStrategy.trace.distance.type";
                ...
                for (ProcessDescriptor descriptor : getAggregator().getAggregatorDescriptor().getPipeline().getList()) {
                    if (descriptor != null && AggregationProcess.class.getName().equals(descriptor.getJavaType())) {
                        for (PropertySection section : descriptor.getProperties().getSections()) {
                            if (HausdorffMatchFrechetMergeStrategy.class.getName().equals(section.getId())) {
    ...
    private void reInit() {
        ...
        if (propertySection != null) {
            for (PropertySet propertySet : propertySection.getPropertySet()) {
                if (Bundle.HausdorffMatchFrechetMergeStrategy_Settings_Name().equals(propertySet.getName())) {
    ...
    private PropertySection createDefaultDescriptor() {
        PropertySet propertySet = new PropertySet(
                Bundle.HausdorffMatchFrechetMergeStrategy_Settings_Name(),
                Bundle.HausdorffMatchFrechetMergeStrategy_Settings_Description());
        propertySet.setId(HausdorffMatchFrechetMergeStrategy.class.getName());

        Property property = new Property();
        property.setId(PROP_NAME_MAX_LOOKAHEAD);
        property.setJavaType(Integer.class.getName());
        property.setName(Bundle.HausdorffMatchFrechetMergeStrategy_MaxLookahead_Name());
        property.setDescription(Bundle.HausdorffMatchFrechetMergeStrategy_MaxLookahead_Description());
        ...
        property.setName(Bundle.HausdorffMatchFrechetMergeStrategy_MaxPathDifference_Name());
        property.setDescription(Bundle.HausdorffMatchFrechetMergeStrategy_MaxPathDifference_Description());
        ...
        property.setJavaType(Double.class.getName());
        property.setName(Bundle.HausdorffMatchFrechetMergeStrategy_MaxInitDistance_Name());
        property.setDescription(Bundle.HausdorffMatchFrechetMergeStrategy_MaxInitDistance_Description());
        property.setValue(MessageFormat.format("{0}", getMaxInitDistance()).replaceAll("[^0-9]", "."));
        propertySet.getProperties().add(property);

        property = new Property();
        property.setName(Bundle.HausdorffMatchFrechetMergeStrategy_MergeHandler_Type_Name());
        property.setDescription(Bundle.HausdorffMatchFrechetMergeStrategy_MergeHandler_Type_Description());
        ...
        property = new Property();
        property.setName(Bundle.HausdorffMatchFrechetMergeStrategy_TraceDistance_Type_Name());
        property.setDescription(Bundle.HausdorffMatchFrechetMergeStrategy_TraceDistance_Type_Description());
        ...
        PropertySection section = new PropertySection(
                Bundle.HausdorffMatchFrechetMergeStrategy_Settings_Name(),
                Bundle.HausdorffMatchFrechetMergeStrategy_Settings_Description());
        section.setId(HausdorffMatchFrechetMergeStrategy.class.getName());
    ...
    private static class StrategyNode extends AbstractNode {
        ...
        private final HausdorffMatchFrechetMergeStrategy strategy;

        public StrategyNode(HausdorffMatchFrechetMergeStrategy strategy) {
            super(Children.LEAF);
            ...
            if (strategy != null) {
                ...
                if (propertySection != null) {
                    for (final de.fub.maps.project.aggregator.xml.PropertySet propertySet : propertySection.getPropertySet()) {
                        if (HausdorffMatchFrechetMergeStrategy.class.getName().equals(propertySet.getId())) {
                            ...
                            for (final de.fub.maps.project.aggregator.xml.Property property : properties) {
                                if (HausdorffMatchFrechetMergeStrategy.PROP_NAME_MAX_LOOKAHEAD.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (HausdorffMatchFrechetMergeStrategy.PROP_NAME_MAX_PATHDIFFERENCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (HausdorffMatchFrechetMergeStrategy.PROP_NAME_MAX_INITDISTANCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (HausdorffMatchFrechetMergeStrategy.PROP_NAME_BASE_MERGEHANDLER_TYPE.equals(property.getId())) {
                                    ClassProperty classProperty = new MergeHandlerProperty(propertySection, property);
                                    set.put(classProperty);
                                } else if (HausdorffMatchFrechetMergeStrategy.PROP_NAME_TRACE_DISTANCE_TYPE.equals(property.getId())) {
