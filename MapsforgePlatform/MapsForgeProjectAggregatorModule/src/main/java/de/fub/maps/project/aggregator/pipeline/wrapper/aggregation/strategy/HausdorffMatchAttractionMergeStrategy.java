 ...
 */
@NbBundle.Messages({
    "HausdorffMatchAttractionMergeStrategy_Name=Hausdorff Match Attraction Merge",
    "HausdorffMatchAttractionMergeStrategy_Description=No description available",
    "HausdorffMatchAttractionMergeStrategy_Settings_Name=Hausdorff Match Attraction Merge Settings",
    "HausdorffMatchAttractionMergeStrategy_Settings_Description=Parameters to configure this aggregations strategy",
    "HausdorffMatchAttractionMergeStrategy_MaxLookahead_Name=Max Lookahead",
    "HausdorffMatchAttractionMergeStrategy_MaxLookahead_Description=No description available",
    "HausdorffMatchAttractionMergeStrategy_MaxPathDifference_Name=Max Path Difference",
    "HausdorffMatchAttractionMergeStrategy_MaxPathDifference_Description=No description available",
    "HausdorffMatchAttractionMergeStrategy_MaxInitDistance_Name=Max Init Distance",
    "HausdorffMatchAttractionMergeStrategy_MaxInitDistance_Description=No description available",
    "HausdorffMatchAttractionMergeStrategy_MergeHandler_Type_Name=MergeHandler Instance Type",
    "HausdorffMatchAttractionMergeStrategy_MergeHandler_Type_Description=The instance that is responsible for merge the data points",
    "HausdorffMatchAttractionMergeStrategy_TraceDistance_Type_Name=TraceDistance Instance Type",
    "HausdorffMatchAttractionMergeStrategy_TraceDistance_Type_Description=The instance which is responsible fo tracing the distance of a segment"
})
@ServiceProvider(service = AggregationStrategy.class)
public class HausdorffMatchAttractionMergeStrategy extends de.fub.agg2graph.agg.strategy.HausdorffMatchDefaultMergeStrategy implements AggregationStrategy {

    private static final Logger LOG = Logger.getLogger(HausdorffMatchAttractionMergeStrategy.class.getName());
    private static final String PROP_NAME_MAX_LOOKAHEAD = "HausdorffMatchAttraction.max.lookahead";
    private static final String PROP_NAME_MAX_PATHDIFFERENCE = "HausdorffMatchAttraction.max.pathdifference";
    private static final String PROP_NAME_MAX_INITDISTANCE = "HausdorffMatchAttraction.max.initDistance";
    private static final String PROP_NAME_BASE_MERGEHANDLER_TYPE = "HausdorffMatchAttraction.base.mergehandler.type";
    private static final String PROP_NAME_TRACE_DISTANCE_TYPE = "HausdorffMatchAttraction.trace.distance.type";
                ...
                for (ProcessDescriptor descriptor : getAggregator().getAggregatorDescriptor().getPipeline().getList()) {
                    if (descriptor != null && AggregationProcess.class.getName().equals(descriptor.getJavaType())) {
                        for (PropertySection section : descriptor.getProperties().getSections()) {
                            if (HausdorffMatchAttractionMergeStrategy.class.getName().equals(section.getId())) {
    ...
    private void reInit() {
        ...
        if (propertySection != null) {
            for (PropertySet propertySet : propertySection.getPropertySet()) {
                if (Bundle.HausdorffMatchAttractionMergeStrategy_Settings_Name().equals(propertySet.getName())) {
    ...
    private PropertySection createDefaultDescriptor() {
        PropertySet propertySet = new PropertySet(
                Bundle.HausdorffMatchAttractionMergeStrategy_Settings_Name(),
                Bundle.HausdorffMatchAttractionMergeStrategy_Settings_Description());
        propertySet.setId(HausdorffMatchAttractionMergeStrategy.class.getName());

        Property property = new Property();
        property.setId(PROP_NAME_MAX_LOOKAHEAD);
        property.setJavaType(Integer.class.getName());
        property.setName(Bundle.HausdorffMatchAttractionMergeStrategy_MaxLookahead_Name());
        property.setDescription(Bundle.HausdorffMatchAttractionMergeStrategy_MaxLookahead_Description());
        ...
        property.setName(Bundle.HausdorffMatchAttractionMergeStrategy_MaxPathDifference_Name());
        property.setDescription(Bundle.HausdorffMatchAttractionMergeStrategy_MaxPathDifference_Description());
        ...
        property.setJavaType(Double.class.getName());
        property.setName(Bundle.HausdorffMatchAttractionMergeStrategy_MaxInitDistance_Name());
        property.setDescription(Bundle.HausdorffMatchAttractionMergeStrategy_MaxInitDistance_Description());
        property.setValue(MessageFormat.format("{0}", getMaxInitDistance()).replaceAll("[^0-9]", "."));
        propertySet.getProperties().add(property);

        property = new Property();
        property.setName(Bundle.HausdorffMatchAttractionMergeStrategy_MergeHandler_Type_Name());
        property.setDescription(Bundle.HausdorffMatchAttractionMergeStrategy_MergeHandler_Type_Description());
        ...
        property = new Property();
        property.setName(Bundle.HausdorffMatchAttractionMergeStrategy_TraceDistance_Type_Name());
        property.setDescription(Bundle.HausdorffMatchAttractionMergeStrategy_TraceDistance_Type_Description());
        ...
        PropertySection section = new PropertySection(
                Bundle.HausdorffMatchAttractionMergeStrategy_Settings_Name(),
                Bundle.HausdorffMatchAttractionMergeStrategy_Settings_Description());
        section.setId(HausdorffMatchAttractionMergeStrategy.class.getName());
    ...
    private static class StrategyNode extends AbstractNode {
        ...
        private final HausdorffMatchAttractionMergeStrategy strategy;

        public StrategyNode(HausdorffMatchAttractionMergeStrategy strategy) {
            super(Children.LEAF);
            ...
            if (strategy != null) {
                ...
                if (propertySection != null) {
                    for (final de.fub.maps.project.aggregator.xml.PropertySet propertySet : propertySection.getPropertySet()) {
                        if (HausdorffMatchAttractionMergeStrategy.class.getName().equals(propertySet.getId())) {
                            ...
                            for (final de.fub.maps.project.aggregator.xml.Property property : properties) {
                                if (HausdorffMatchAttractionMergeStrategy.PROP_NAME_MAX_LOOKAHEAD.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (HausdorffMatchAttractionMergeStrategy.PROP_NAME_MAX_PATHDIFFERENCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (HausdorffMatchAttractionMergeStrategy.PROP_NAME_MAX_INITDISTANCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (HausdorffMatchAttractionMergeStrategy.PROP_NAME_BASE_MERGEHANDLER_TYPE.equals(property.getId())) {
                                    ClassProperty classProperty = new MergeHandlerProperty(propertySection, property);
                                    set.put(classProperty);
                                } else if (HausdorffMatchAttractionMergeStrategy.PROP_NAME_TRACE_DISTANCE_TYPE.equals(property.getId())) {
