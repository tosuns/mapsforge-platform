 ...
 */
@NbBundle.Messages({
    "HausdorffMatchIterativeMergeStrategy_Name=Hausdorff Match Iterative Merge",
    "HausdorffMatchIterativeMergeStrategy_Description=No description available",
    "HausdorffMatchIterativeMergeStrategy_Settings_Name=Hausdorff Match Iterative Merge Settings",
    "HausdorffMatchIterativeMergeStrategy_Settings_Description=Parameters to configure this aggregations strategy",
    "HausdorffMatchIterativeMergeStrategy_MaxLookahead_Name=Max Lookahead",
    "HausdorffMatchIterativeMergeStrategy_MaxLookahead_Description=No description available",
    "HausdorffMatchIterativeMergeStrategy_MaxPathDifference_Name=Max Path Difference",
    "HausdorffMatchIterativeMergeStrategy_MaxPathDifference_Description=No description available",
    "HausdorffMatchIterativeMergeStrategy_MaxInitDistance_Name=Max Init Distance",
    "HausdorffMatchIterativeMergeStrategy_MaxInitDistance_Description=No description available",
    "HausdorffMatchIterativeMergeStrategy_MergeHandler_Type_Name=MergeHandler Instance Type",
    "HausdorffMatchIterativeMergeStrategy_MergeHandler_Type_Description=The instance that is responsible for merge the data points",
    "HausdorffMatchIterativeMergeStrategy_TraceDistance_Type_Name=TraceDistance Instance Type",
    "HausdorffMatchIterativeMergeStrategy_TraceDistance_Type_Description=The instance which is responsible fo tracing the distance of a segment"
})
@ServiceProvider(service = AggregationStrategy.class)
public class HausdorffMatchIterativeMergeStrategy extends de.fub.agg2graph.agg.strategy.HausdorffMatchIterativeMergeStrategy implements AggregationStrategy {
                ...
                for (ProcessDescriptor descriptor : getAggregator().getAggregatorDescriptor().getPipeline().getList()) {
                    if (descriptor != null && AggregationProcess.class.getName().equals(descriptor.getJavaType())) {
                        for (PropertySection section : descriptor.getProperties().getSections()) {
                            if (HausdorffMatchIterativeMergeStrategy.class.getName().equals(section.getId())) {
    ...
    private void reInit() {
        ...
        if (propertySection != null) {
            for (PropertySet propertySet : propertySection.getPropertySet()) {
                if (Bundle.HausdorffMatchIterativeMergeStrategy_Settings_Name().equals(propertySet.getName())) {
    ...
    private PropertySection createDefaultDescriptor() {
        PropertySet propertySet = new PropertySet(
                Bundle.HausdorffMatchIterativeMergeStrategy_Settings_Name(),
                Bundle.HausdorffMatchIterativeMergeStrategy_Settings_Description());
        propertySet.setId(HausdorffMatchIterativeMergeStrategy.class.getName());

        Property property = new Property();
        property.setId(PROP_NAME_MAX_LOOKAHEAD);
        property.setJavaType(Integer.class.getName());
        property.setName(Bundle.HausdorffMatchIterativeMergeStrategy_MaxLookahead_Name());
        property.setDescription(Bundle.HausdorffMatchIterativeMergeStrategy_MaxLookahead_Description());
        ...
        property.setName(Bundle.HausdorffMatchIterativeMergeStrategy_MaxPathDifference_Name());
        property.setDescription(Bundle.HausdorffMatchIterativeMergeStrategy_MaxPathDifference_Description());
        ...
        property.setJavaType(Double.class.getName());
        property.setName(Bundle.HausdorffMatchIterativeMergeStrategy_MaxInitDistance_Name());
        property.setDescription(Bundle.HausdorffMatchIterativeMergeStrategy_MaxInitDistance_Description());
        property.setValue(MessageFormat.format("{0}", getMaxInitDistance()).replaceAll("[^0-9]", "."));
        propertySet.getProperties().add(property);

        property = new Property();
        property.setName(Bundle.HausdorffMatchIterativeMergeStrategy_MergeHandler_Type_Name());
        property.setDescription(Bundle.HausdorffMatchIterativeMergeStrategy_MergeHandler_Type_Description());
        ...
        property = new Property();
        property.setName(Bundle.HausdorffMatchIterativeMergeStrategy_TraceDistance_Type_Name());
        property.setDescription(Bundle.HausdorffMatchIterativeMergeStrategy_TraceDistance_Type_Description());
        ...
        PropertySection section = new PropertySection(
                Bundle.HausdorffMatchIterativeMergeStrategy_Settings_Name(),
                Bundle.HausdorffMatchIterativeMergeStrategy_Settings_Description());
        section.setId(HausdorffMatchIterativeMergeStrategy.class.getName());
    ...
    private static class StrategyNode extends AbstractNode {
        ...
        private final HausdorffMatchIterativeMergeStrategy strategy;

        public StrategyNode(HausdorffMatchIterativeMergeStrategy strategy) {
            super(Children.LEAF);
            ...
            if (strategy != null) {
                ...
                if (propertySection != null) {
                    for (final de.fub.maps.project.aggregator.xml.PropertySet propertySet : propertySection.getPropertySet()) {
                        if (HausdorffMatchIterativeMergeStrategy.class.getName().equals(propertySet.getId())) {
                            ...
                            for (final de.fub.maps.project.aggregator.xml.Property property : properties) {
                                if (HausdorffMatchIterativeMergeStrategy.PROP_NAME_MAX_LOOKAHEAD.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (HausdorffMatchIterativeMergeStrategy.PROP_NAME_MAX_PATHDIFFERENCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (HausdorffMatchIterativeMergeStrategy.PROP_NAME_MAX_INITDISTANCE.equals(property.getId())) {
                                    set.put(new NodeProperty(property));
                                } else if (HausdorffMatchIterativeMergeStrategy.PROP_NAME_BASE_MERGEHANDLER_TYPE.equals(property.getId())) {
                                    ClassProperty classProperty = new MergeHandlerProperty(propertySection, property);
                                    set.put(classProperty);
                                } else if (HausdorffMatchIterativeMergeStrategy.PROP_NAME_TRACE_DISTANCE_TYPE.equals(property.getId())) {
