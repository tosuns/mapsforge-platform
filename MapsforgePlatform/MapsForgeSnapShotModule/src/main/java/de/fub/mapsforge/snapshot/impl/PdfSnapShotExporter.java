...
public class PdfSnapShotExporter extends AbstractComponentSnapShotExporter {
    ...
    private void handleExport(File selectedFile, Component component) {
        if (component != null) {
            ...
            try {
                ...
                PdfTemplate map = cb.createTemplate(component.getWidth(), component.getHeight());
                pdfGraphics2D = new PdfGraphics2D(map, component.getWidth(), component.getHeight());
