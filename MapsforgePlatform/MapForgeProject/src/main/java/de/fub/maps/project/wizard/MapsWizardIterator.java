...
public class MapsWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {
    ...
    public MapsWizardIterator() {
    }

    public static MapsWizardIterator createIterator() {
        return new MapsWizardIterator();
    }
    ...
    private String[] createSteps() {
        return new String[]{
            NbBundle.getMessage(MapsWizardIterator.class, "LBL_CreateProjectStep")
        };
    }
