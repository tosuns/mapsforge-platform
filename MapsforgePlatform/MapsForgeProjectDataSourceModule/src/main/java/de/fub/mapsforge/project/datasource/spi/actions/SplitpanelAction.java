...
import de.fub.mapsforge.project.datasource.ui.MapViewElement;
...
public class SplitpanelAction extends AbstractAction {
    ...
    @StaticResource
    private static final String ICON_PATH = "de/fub/mapsforge/project/datasource/ui/splitPanelIcon.png";
