 ...
 * {@link de.fub.agg2graph.gpseval.data.filter.WaypointFilter WaypointFilter}s. Weka is
 * run using the {@link de.fub.agg2graph.gpseval.WekaEval WekaEval}-class. All information
 * needed for the test-case is loaded from a
 * {@link de.fub.agg2graph.gpseval.Config Config}-object.
 */
public class TestCase {
    ...
    /**
     * Create a test-case based on a {@link de.fub.agg2graph.gpseval.Config Config}.
     *
     * @param cfg
     */
     ...
     * @throws Exception
     */
    public TestResult run() throws FileNotFoundException, IOException, NoDataException, Exception {
        // 1. Load GPS-tracks
        ...
        return new TestResult(mCfg, eval.getCrossValidationResults(), eval.getTrainingTestResults());
    }
