...
public class HausdorffMatchAttractionMergeStrategy extends
    ...
    public HausdorffMatchAttractionMergeStrategy() {
        statistic = new MyStatistic(
                "agg2graph/test/exp/Evaluation-HausdorffMatchAttractionMerge.txt");
