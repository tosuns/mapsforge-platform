 ...
 * extension.
 *
 * <p>You can register your own TrackFile-class for a file extension (see
 * {@link de.fub.agg2graph.gpseval.data.file.TrackFileFactory#registerGPSDataFileClass(java.lang.String, java.lang.Class) registerGPSDataFileClass}).</p>
 *
 * @see
 */
public class TrackFileFactory {
     ...
     */
    public void registerGPSDataFileClass(String extension, Class<? extends TrackFile> gpsDataFileClass) {
    ...
    public TrackFile newGPSDataFile(Path file) {
        ...
        Class<? extends TrackFile> gpsDataFileClass = mGPSDataFileClasses.get(extension);
        ...
        if (gpsDataFileClass != null) {
            try {
                ...
                Logger.getLogger(TrackFileFactory.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
