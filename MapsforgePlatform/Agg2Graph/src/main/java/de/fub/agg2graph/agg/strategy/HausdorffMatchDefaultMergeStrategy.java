...
public class HausdorffMatchDefaultMergeStrategy extends
    ...
    public HausdorffMatchDefaultMergeStrategy() {
        statistic = new MyStatistic(
                "agg2graph/test/exp/Evaluation-HausdorffMatchDefaultMerge.txt");
