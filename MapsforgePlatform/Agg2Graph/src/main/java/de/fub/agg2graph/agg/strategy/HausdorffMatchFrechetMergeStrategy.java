...
public class HausdorffMatchFrechetMergeStrategy extends AbstractAggregationStrategy {

    MyStatistic statistic;
    int counter = 1;

    private int maxLookahead = Integer.MAX_VALUE;
    private double maxPathDifference = 200;
    private double maxInitDistance = 35;//12.5
    ...
    public HausdorffMatchFrechetMergeStrategy() {
        statistic = new MyStatistic(
                "agg2graph/test/exp/Evaluation-HausdorffMatchFrechetMerge.txt");
    ...
    public void aggregate(GPSSegment segment, boolean isAgg) {
        ...
        matchedPoints = new ArrayList<GPSPoint>();
