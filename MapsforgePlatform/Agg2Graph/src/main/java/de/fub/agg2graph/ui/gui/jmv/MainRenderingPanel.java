...
public class MainRenderingPanel extends OsmPanel implements IRenderingPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        LayerManager lm = getUi().getLayerManager();
        GeoPosition lt = convertPointToGeoPosition(new Point2D.Double(0, getHeight()));
        GPSPoint leftTop = new GPSPoint(lt.getLatitude(), lt.getLongitude());
        GeoPosition br = convertPointToGeoPosition(new Point2D.Double(getWidth(), 0));
        GPSPoint bottomRight = new GPSPoint(br.getLatitude(), br.getLongitude());
