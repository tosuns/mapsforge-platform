...
public class PathScoreMatchIterativeMergeStrategy extends
    ...
    private double maxPathDifference = 15;
     ...
     */
    public PathScoreMatchIterativeMergeStrategy() {
        statistic = new MyStatistic(
                "agg2graph/test/exp/Evaluation-DefaultMatchIterativeMerge.txt");
