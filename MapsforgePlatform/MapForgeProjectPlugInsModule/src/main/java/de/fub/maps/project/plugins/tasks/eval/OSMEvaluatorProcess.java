...
import de.fub.maps.project.openstreetmap.xml.osm.Nd;
import de.fub.maps.project.openstreetmap.xml.osm.Node;
import de.fub.maps.project.openstreetmap.xml.osm.Osm;
import de.fub.maps.project.openstreetmap.xml.osm.Way;
...
public class OSMEvaluatorProcess extends AbstractAggregationProcess<RoadNetwork, RoadNetwork> implements StatisticProvider {
    ...
    @StaticResource
    private static final String ICON_PATH = "de/fub/maps/project/plugins/tasks/eval/datasourceProcessIcon.png";
    ...
    private static class OSMEvaluatorProcessNode extends AggregationProcessNode {
        ...
        private class MapMatcherProperty extends ClassProperty {
            ...
            public MapMatcherProperty(de.fub.maps.project.aggregator.xml.Property property) {
        ...
        private class MapProviderProperty extends ClassProperty {
            ...
            public MapProviderProperty(de.fub.maps.project.aggregator.xml.Property property) {
